...
class StrainOptimizer:
    ...
    def calculate_fitness(self, genome: StrainGenome, 
        ...
        perchlorate_concentration = environment_conditions.get('perchlorate_concentration', 0.007)
        ...
        stress_tolerance = (
            ...
            (genome.cold_shock_proteins * (1 - temp_stress) +
             ...
             genome.antioxidant_proteins * (1 - uv_stress)) / 3
        )
        ...
        energy_balance = 1.0 - abs(
            ...
            genome.energy_allocation_remediation - 1.0
        )
    ...
    def evaluate_population(self, environment_conditions: Dict[str, float]) -> List[Tuple[StrainGenome, float]]:
        """
    ...
    def select_parents(self, fitness_scores: List[Tuple[StrainGenome, float]]) -> List[StrainGenome]:
        """
    ...
    def optimize(self, environment_conditions: Dict[str, float], 
                generations: int = 100) -> Tuple[StrainGenome, List[float]]:
        """
    ...
    def plot_optimization_progress(self, fitness_history: List[float], 
        ...
        if self.best_genome:
            ...
            # Metabolic parameters
            plt.subplot(2, 2, 2)
            metabolic_params = ['growth_rate', 'perchlorate_reduction_rate', 'stress_tolerance']
            ...
            # Protein expression
            plt.subplot(2, 2, 3)
            protein_params = ['cold_shock_proteins', 'osmotic_stress_proteins', 
                           'antioxidant_proteins', 'perchlorate_reductase']
            ...
            # Energy allocation
            plt.subplot(2, 2, 4)
            energy_params = ['energy_allocation_growth', 'energy_allocation_stress', 
