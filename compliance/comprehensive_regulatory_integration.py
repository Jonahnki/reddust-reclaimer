...
from international.international_regulatory_framework import InternationalRegulatoryFramework
...
class ComprehensiveRegulatoryIntegration:
    ...
    def run_nasa_ppo_compliance(self) -> Dict[str, any]:
        ...
        mission_data = {
            'bioburden_density': self.params.target_bioburden_limit * 0.75,  # Below limit
        ...
        contamination_risk = self.ppo_compliance.assess_contamination_risk(0.15, 0.05, 0.01)
        ...
        return {
            ...
            'compliance_achieved': (
                bioburden_metrics['compliance_achieved'] and 
    ...
    def run_international_compliance(self) -> Dict[str, any]:
        ...
        international_package = self.international_framework.create_international_compliance_package(mission_data)
        ...
        return {
            ...
            'compliance_achieved': international_package['compliance_summary']['overall_international_compliance']
        }
    ...
    def run_comprehensive_integration(self) -> Dict[str, any]:
        ...
        overall_compliance = (
            ppo_results['compliance_achieved'] and
            international_results['compliance_achieved'] and
        ...
        integration_report = {
            ...
            'overall_compliance': {
                ...
                'international_compliance': international_results['compliance_achieved'],
                'durc_approval': durc_results['overall_approval'],
                'overall_compliance': overall_compliance,
                'compliance_level': self._determine_compliance_level(overall_compliance),
                'recommendation': self._generate_overall_recommendation(overall_compliance)
            },
            'regulatory_summary': {
    ...
    def plot_comprehensive_compliance_metrics(self, save_path: Optional[str] = None) -> None:
        """
        ...
        if not self.integration_results:
            logger.error("No integration results available. Run comprehensive_integration first.")
            return
        ...
        int_values = [
            int_data['cospar_compliance']['category_iv_compliance']['overall_compliance'],
            True,  # Assuming ESA compliance
            int_data['un_treaty_compliance']['article_ix_compliance']['overall_compliance'],
        ...
        durc_values = [
            ...
            1 if durc_data['ibc_review']['approval_status'] in ['APPROVED', 'CONDITIONAL_APPROVAL'] else 0,
    ...
    def generate_regulatory_compliance_report(self) -> str:
        ...
        """
        if not self.integration_results:
            return "No integration results available. Run comprehensive_integration first."
...
Report generated by: Comprehensive Regulatory Compliance Integration System
    ...
    def save_comprehensive_integration_report(self, filepath: str) -> None:
        ...
        logger.info(f"Comprehensive integration report saved to {json_filepath} and {txt_filepath}")
...
def main():
    ...
    integration.save_comprehensive_integration_report('compliance/comprehensive_regulatory_report')
    
    # Print summary
    print("\n=== Comprehensive Regulatory Compliance Summary ===")
    print(f"Mission: {params.mission_name}")
    print(f"NASA PPO Compliance: {integration_results['overall_compliance']['ppo_compliance']}")
    print(f"International Compliance: {integration_results['overall_compliance']['international_compliance']}")
    print(f"DURC Approval: {integration_results['overall_compliance']['durc_approval']}")
    print(f"Overall Compliance: {integration_results['overall_compliance']['overall_compliance']}")
    print(f"Compliance Level: {integration_results['overall_compliance']['compliance_level']}")
    print(f"Recommendation: {integration_results['overall_compliance']['recommendation']}")
    
    print(f"\nCompliance Percentage: {integration_results['regulatory_summary']['compliance_percentage']:.1f}%")
    print(f"Compliant Areas: {integration_results['regulatory_summary']['compliant_areas']}/3")
