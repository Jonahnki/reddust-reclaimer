...
class PPOCategoryIVCompliance:
    ...
    def calculate_bioburden_reduction(self) -> Dict[str, float]:
        ...
        final_bioburden = initial_bioburden * (1 - self.bioburden_assessment.sterilization_efficiency)
        final_density = final_bioburden / self.bioburden_assessment.spacecraft_surface_area
        
        reduction_factor = initial_bioburden / final_bioburden if final_bioburden > 0 else float('inf')
        ...
        return {
            ...
            'compliance_achieved': final_density <= self.bioburden_assessment.target_bioburden_limit
        }
    
    def assess_contamination_risk(self, 
                                survival_probability: float,
                                replication_rate: float,
                                dispersal_capability: float) -> Dict[str, float]:
        """
        ...
        replication_risk = survival_risk * replication_rate * self.bioburden_assessment.mission_duration_years
        ...
        return {
            ...
            'compliance_achieved': total_contamination_probability <= self.bioburden_assessment.contamination_probability_threshold
        }
    ...
    def generate_ppo_submission_documents(self) -> Dict[str, any]:
        ...
        submission_documents = {
            ...
            'bioburden_assessment': {
                ...
                'sterilization_efficiency': bioburden_metrics['sterilization_efficiency'],
            ...
            'contamination_risk_assessment': {
                'total_contamination_probability': contamination_risk['total_contamination_probability'],
            ...
            'compliance_summary': {
                ...
                'contamination_risk_compliance': contamination_risk['compliance_achieved'],
                'overall_compliance': (
    ...
    def plot_compliance_metrics(self, save_path: Optional[str] = None) -> None:
        ...
        # Bioburden reduction
        axes[0, 0].bar(['Initial', 'Final'], 
                       [bioburden_metrics['initial_bioburden'], bioburden_metrics['final_bioburden']])
        axes[0, 0].set_title('Bioburden Reduction')
        axes[0, 0].set_ylabel('Total Spores')
        axes[0, 0].grid(True, alpha=0.3)
        
        # Density comparison
        density_data = [bioburden_metrics['initial_density_spores_m2'], 
        ...
        compliance_values = [
            ...
            contamination_risk['compliance_achieved'],
            (bioburden_metrics['compliance_achieved'] and contamination_risk['compliance_achieved'])
        ]
...
def main():
    ...
    print(f"Overall Compliance: {submission_documents['compliance_summary']['overall_compliance']}")
    print(f"Recommendation: {submission_documents['compliance_summary']['recommendation']}")
    
    print(f"\nBioburden Reduction Factor: {bioburden_metrics['reduction_factor']:.1f}")
    print(f"Final Bioburden Density: {bioburden_metrics['final_density_spores_m2']:.4f} spores/m²")
    print(f"Category IV Limit: {ppo_compliance.bioburden_assessment.target_bioburden_limit} spores/m²")
